...
![Command prompt showing the output of tailwindcss.exe --help](/tailwindcss-demo/tailwincss-help.png)
...
![RAD Studio Build Events page with the Tailwind post-build command](/tailwindcss-demo/build-events.png)
...
![The demo's sidebar, with the Users entry highlighted as active](/tailwindcss-demo/sidebar-users.png)
